...
public class VentanaConFondo_turbio extends JFrame {
    ...
    public VentanaConFondo_turbio(String nombreJugador) {
        ...
        panelImagenes[0] = new Imagen("/resources/pantallaUno_turbio.png");
        panelImagenes[1] = new Imagen("/resources/pantallaDos_turbio.png");
        panelImagenes[2] = new Imagen("/resources/pantallaTres_turbio.png");
        panelImagenes[3] = new Imagen("/resources/pantallaCuatro_turbio.png");
