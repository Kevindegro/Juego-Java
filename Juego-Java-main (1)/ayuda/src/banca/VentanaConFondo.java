...
public class VentanaConFondo extends JFrame {
    ...
    public VentanaConFondo(String nombreJugador) {
     ...
     // Crear la segunda pantalla en negro con texto progresivo
        ...
        panelImagenes[0] = new Imagen("/resources/pantallaUno.png");
        panelImagenes[1] = new Imagen("/resources/pantallaDos.png");
        panelImagenes[2] = new Imagen("/resources/pantallaTres.png");
        panelImagenes[3] = new Imagen("/resources/pantallaCuatro.png");
